...
# 🦁 XXD Panel 106｜ذاكرة البكسل الناعمة

### اختزل الصورة حتى لا يبقى إلا روحها، ثم تذكّرها من جديد ببكسلات ناعمة اللون
...
تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. يولّد Panel 106 كل عمل مستقلاً ومباشرة من صورته الأصلية في مرور واحد، من دون استخدام Panel آخر أو نتيجة وسيطة. كلا اتجاهي المقارنة منطقتان فقط بنسبة 50:50، وتستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## الحالات المناسبة والمشكلات التي يحلها

قد تمتلئ الصورة بالتفاصيل، بينما لا يبقى في الذاكرة سوى خط خارجي أو حركة أو مسافة أو بقعة لون. يختار **Panel 106** مرتكزين إلى أربعة مرتكزات بصرية تحدد هوية الصورة، ثم يعيد بناءها كذاكرة بكسلية ناعمة ومضيئة ذات نظام هندسي واضح: تبدو من بعيد تكويناً تجريدياً راقياً، ومن قريب تظل صورتك نفسها بلا التباس.

### مناسب عندما

- **تكون الصورة معقدة لكنك لا تريد فقدان هويتها:** يحذف الأشياء الثانوية والبنى الدقيقة، ولا يبقي إلا الخطوط والوضعية والاتجاه وعلاقات اللون التي تجعل الصورة هي نفسها.
- **تريد ملصقاً تجريدياً لا زخرفة مجهولة:** يستخدم شبكة منتظمة وكتلاً حادة الحواف وتهشيراً نقطياً موضعياً وعلاقات الشكل الموجب والسالب كي يظهر الموضوع تدريجياً من داخل التجريد.
- **تريد ألواناً منعشة ومريحة بلا حلاوة رخيصة:** يعيد مزج الأبيض الكريمي والوردي الخوخي والأزرق الحليبي والأخضر النعناعي وغيرها من ألوان الأصل في لوحة محدودة ناعمة ومضيئة.
...
- لا يصغّر الصورة أو يضع مرشحاً عليها أو يحول عناصرها واحداً واحداً إلى بكسلات؛ بل يعيد بناء كل نتيجة مباشرة من الأصل الحالي في مرور واحد.
- تشترك المرتكزات البصرية، وعددها من اثنين إلى أربعة، في مركز بصري واحد بدلاً من أن تصبح بطاقات أو شبكة أو جدار كولاج.
- يحتوي نمط المقارنة على منطقتين فقط بنسبة 50:50: في أعلى–أسفل تكون الصورة الحقيقية فوق والتصميم تحت، وفي يسار–يمين تكون الصورة الحقيقية يساراً والتصميم يميناً، من دون شريط ثالث.

### بداية سريعة

> استخدم XXD Panel 106 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** 2–4 مرتكزات بصرية · بكسلات هندسية · كتل لونية معيارية · حدود حادة · تهشير نقطي موضعي · مركز بصري واحد · فراغ واسع · لوحة محدودة ناعمة ومضيئة
...
|---|---|
| **الناتج** | ملصق «ذاكرة بكسلية» تجريدي راقٍ لا يبقي إلا المرتكزات الأهم، وعددها من اثنين إلى أربعة |
| **البصمة الواضحة** | شبكة منتظمة وكتل باستيلية معيارية وحدود حادة وتهشير نقطي موضعي ومركز بصري واحد وفراغ واسع |
| **احترام المصدر** | تحتفظ الصورة الواقعية بالهوية والبنية والملمس الطبيعي؛ ويختزل التصميم بقوة مع إبقاء الخط الحاسم والوضعية واتجاه الفضاء والشعور بدقة |
...
```text
قراءة الهوية والشعور → اختيار 2–4 مرتكزات بصرية حاسمة → حذف الأشياء الثانوية والتفاصيل الدقيقة → تحويلها إلى شبكة منتظمة وكتل معيارية وحدود حادة → بناء العمق بالتهشير النقطي الموضعي والشكل الموجب والسالب والفراغ → إكمال ذاكرة بكسلية ناعمة تبدو تجريدية وتظل هذه الصورة نفسها
```

## سمات النتيجة النهائية

- لا يبقى سوى 2–4 مرتكزات بصرية عالية القيمة، تُنظّم حول مركز واحد بدلاً من تقسيمها إلى مشاهد صغيرة متعددة.
- تصنع الأشكال البكسلية الكبيرة والشبكات المنتظمة والحدود الحادة والمصفوفات المتكررة والتهشير النقطي الموضعي وعلاقات الشكل الموجب والسالب طبقات هندسية واضحة.
- تُقرأ من بعيد كتجريد راقٍ، ومن قريب يظهر الموضوع تدريجياً؛ ولا تُنسخ كل ورقة أو نافذة أو ملامح وجه كاملة أو ثنيات ملابس أو بنية ميكانيكية.
- تُستخلص أنعم علاقات اللون وأكثرها سطوعاً وألفة من الأصل في لوحة شفافة محدودة يقودها الأبيض الكريمي والوردي الخوخي والأزرق الحليبي والأخضر النعناعي.
- لا يعمل النص البكسلي أو النقطي القليل إلا كملاحظة تحريرية؛ ويُتجنب شكل لقطات الألعاب، والتحويل الحرفي للصورة إلى بكسلات، وشبكات البطاقات، والشريط الثالث، وإعادة التنسيق في مرور ثانٍ.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-106-prompt.en.md)
...
يحافظ نمط أعلى–أسفل على لوحة 3:4 الأصلية وتقسيم 50:50 الدقيق، وينقل نمط يسار–يمين مبدأ التساوي نفسه إلى تقسيم عمودي دقيق 50:50. لا تستبدل الحاوية الثنائية إلا أوضاع التصميم فقط والخلفيات، من دون تغيير جمالية ذاكرة البكسل الناعمة. يُرسَل إلى GPT Image 2 عقد نمط واحد مختار فقط لكل نتيجة.
...
- `top-bottom`: منطقتان فقط متساويتان في الارتفاع بنسبة 50:50، الصورة الواقعية فوق والتصميم تحت. تبقى الكتابة داخل المنطقة السفلية، وتُمنع أشرطة العنوان والتذييل والمنطقة الثالثة.
- `left-right`: منطقتان فقط متساويتان في العرض بنسبة 50:50، الصورة الواقعية يساراً والتصميم يميناً. تبقى الكتابة داخل المنطقة اليمنى، ويُمنع تحويلها إلى أعلى–أسفل أو إضافة شريط ثالث.
...
التقسيم الثنائي 50:50 قاعدة أصيلة في Panel 106 ولا يحتاج إلى طلب جديد. تُولّد كل لوحة مباشرة من الأصل الحالي في مرور واحد، ولا يُستخدم ناتج وسيط أو فاشل كمرحلة ثانية. يمكن تدقيق المنتصف عند الحاجة، ولا يُستخدم الدمج الحتمي إلا إذا أخفق التوليد في عقد التقسيم أو لزم حفظ بكسلات المصدر كما هي.
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 106. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
يتولى نموذج الصور إعادة البناء الجمالي للعمل النهائي كله، وتُولّد التركيبات الثنائية كلوحة كاملة واحدة مباشرة من الأصل الحالي بلا إعادة تنسيق في مرور ثانٍ. ولا يُستخدم `scripts/compose_panel.py` إلا لتدقيق منتصف 50:50 والاسترداد المشروط ومعايرة البكسلات بلا فقد؛ ولا يحكم على النجاح الجمالي.
...
/xxd-panel-106 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-106 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-106 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-106 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-106 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 106 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-106 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-106`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-106-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-106-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

تم تحديث سلسلة XXD Panel الحالية لتشمل 001–112، ويحتفظ كل Panel بموجّهه الأصلي ومنطقه الجمالي المستقل. الجدول أدناه هو الدليل التاريخي حتى وقت إصدار هذا المشروع؛ يسرد 001–106 بصورة متتابعة، ويظهر المشروع الحالي بخط عريض.
